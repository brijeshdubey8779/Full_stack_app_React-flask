...
function Home() {
    return (
        <div className='min-h-screen p-0 flex flex-wrap justify-center         items-center bg-white'>
            <div className='max-w-4xl bg-slate-500 h-52'>
                <h1 className='text-3xl font-bold text-center'>Welcome, I'm a developer</h1>
                <p className='text-xl'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis atque in dignissimos beatae, similique molestiae quis veniam id quae maiores est earum eum nam libero illum pariatur. Molestias, repellat voluptates.
                </p>
